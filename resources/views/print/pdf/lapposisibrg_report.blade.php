            ...
            <table id="mytable" border="1px" cellspacing="0">
                <thead>
                    <tr align="center" class="" style="font-weight: bold;">
                        <td scope="col" class="border-bottom-0 border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">No</td>
                        <td scope="col" colspan="9" class="border-bottom-0 border-end-0 border-2" align="center"
                            style="width: 105px; word-wrap: break-word;">Dokumen Pemasukan</td>
                        <td scope="col" colspan="9" class="border-bottom-0 border-end-0 border-2" align="center"
                            style="width: 105px; word-wrap: break-word;">Dokumen Pengeluaran</td>
                        <td scope="col" colspan="3" class="border-bottom-0 border-end-0 border-2" align="center"
                            style="width: 105px; word-wrap: break-word;">Saldo</td>
                    </tr>
                    <tr align="center" class="border-top-0 border-bottom-0 border-end-0 border-2">
                        <th scope="col" class="border-top-0 border-bottom-0 border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;"></th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Jenis</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">No</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Tgl</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Tgl Msk</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 50px; word-wrap: break-word;">Kode Brg</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Nama Brg</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Sat.</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Jml</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Nil. Pabean</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Jenis</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">No</th>
                        ...
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Tgl Msk</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Kode Brg</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Nama Brg</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Sat.</th>
                        ...
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Nil. Pabean</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Jmlh</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Sat.</th>
                        <th scope="col" class="border-top-0 border-bottom-0  border-bottom-0 border-end-0 border-2"
                            style="width: 105px; word-wrap: break-word;">Nil. Pabean</th>
                            ...
                            <tr>
                                ...
                                @if ($groupkey == '')
                                    ...
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->uom }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($item->qty2, 0, '.', '.') }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($item->cif2, 0, '.', '.') }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($item->Saldo_Jmlh, 0, '.', '.') }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->Saldo_Sat }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($item->Saldo_Nil_Pabean, 0, '.', '.') }}</td>
                                    @php
                                        $groupkey = $item->nopendaftaran;
                                        $jmlsaldo_old = $jmlsaldo;
                                    @endphp
                                @elseif($groupkey != $item->nopendaftaran)
                                    @php
                                        $groupkey = $item->nopendaftaran;
                                        $jmlsaldo = $item->qty - $item->qty2;
                                    @endphp
                                    {{-- <td class="border-2">{{ $groupkey }}</td> --}}
                                    <th scope="row" class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $no }}</th>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->jenis }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                ...
                                @elseif($groupkey == $item->nopendaftaran)
                                    @php
                                        ...
                                        $sa++;
                                    @endphp
                                    {{-- <td class="border-2">{{ $groupkey." ".$sa }} jing</td> --}}
                                    <th scope="row" class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $no }}</th>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->jenis }}</td>
                                    ...
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->satuan }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($jmlsaldo_old, 0, '.', '.') }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ number_format($item->cif, 0, '.', '.') }}</td>
                                    <td class="border-2" style="width: 105px; word-wrap: break-word;">
                                        {{ $item->jenis2 }}</td>
