...
<div class="sidebar" id="sidebar">
    ...
    <div class="head-sidebar">
        <a href="{{ 'pemasukan' }}" class="logo-btn"><img src="img/logo_pjt.png" alt=""
                class="logo color-light"><span>IT
    ...
    <a href="{{ 'lapposisibrg' }}" class="btn_Nav {{ 'lapposisibrg' == request()->path() ? 'btn_NavActive' : '' }}"><i
            class="fa-regular fa-note-sticky"></i><span>Laporan Posisi Barang</span></a>
    ...
    <a href="{{ 'mutasibrgjadi' }}"
        class="btn_Nav {{ 'mutasibrgjadi' == request()->path() ? 'btn_NavActive' : '' }}"><i
    ...
    <a href="{{ 'mutasiloghist' }}"
        class="btn_Nav {{ 'mutasiloghist' == request()->path() ? 'btn_NavActive' : '' }}"><i
